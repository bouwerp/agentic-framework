...
description: This skill should be used when an agent needs to write tests, implement features using TDD, add test coverage, fix failing tests, or generate regression tests from bugs. Use when the user asks to "write tests", "add tests", "use TDD", "test this", "add coverage", or when implementing any non-trivial feature. Provides the red-green-refactor workflow, framework detection, test patterns across languages, edge case strategies, and test quality guidance.
version: 1.0.0
---
